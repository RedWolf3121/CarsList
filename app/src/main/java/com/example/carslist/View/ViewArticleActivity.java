        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(post != null){
                    ...
                    Glide.with(getApplicationContext()).load(post.img).into(image_display);
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ViewArticleActivity.this, "No se ha cargado correctamente!", Toast.LENGTH_SHORT).show();
            }
        });
